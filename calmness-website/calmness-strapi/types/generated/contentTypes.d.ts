...
export interface ApiPageAProposPageAPropos extends Schema.SingleType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    histoire: Attribute.RichText & Attribute.Required;
    mission: Attribute.RichText & Attribute.Required;
    ...
    > &
      Attribute.Private;
    valeurs: Attribute.RichText & Attribute.Required;
  };
}
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  info: {
    description: "Services offerts par l'entreprise";
    displayName: 'Service';
    pluralName: 'services';
